...
But, if the data you wanted to display is not a matrix, but on another form, you gotta have to configure it by building a custom spec with `new_corr_data()` for full control over which values appear.
