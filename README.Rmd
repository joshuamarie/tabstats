...
This package allows end users to apply advanced styling and alignment to tables, such as color coding, column alignment, and borders, making it easier to view large datasets directly in the command line.
